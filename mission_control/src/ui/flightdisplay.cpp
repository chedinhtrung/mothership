...
void FlightDisplay::initializeGL()
{
    ...
    // stuff to make lines and points round
...
void FlightDisplay::draw_heading_markers(float heading, float r)
{
    ...
    for (int i = -36; i <= 36; i++)
    {
        ...
        if (i % 2)
        {
            marker_len = large_marker;
        }
        else
        {
            marker_len = small_marker;
        }
